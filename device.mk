...
PRODUCT_COPY_FILES += \
		...
		$(LOCAL_PATH)/4g_modem/lib64/libreference-ril-ec20.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libreference-ril-ec20.so
else
PRODUCT_PROPERTY_OVERRIDES += \
...
PRODUCT_COPY_FILES += \
		...
		$(LOCAL_PATH)/4g_modem/lib32/libreference-ril-ec20.so:$(TARGET_COPY_OUT_VENDOR)/lib/libreference-ril-ec20.so
